...
- **time lag a** & **time lag b**: set the lag/slew time for **time**. set to 0 for instantaneous changes (clicky), set > 0 for smoothed encoder movements or portamento comb pitch modulation.
